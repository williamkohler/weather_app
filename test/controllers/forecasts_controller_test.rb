...
class ForecastsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create forecast" do
    assert_difference("Forecast.count") do
      post forecasts_url, params: { forecast: { address: @forecast.address, data: @forecast.data } }
    end
  ...
  test "should update forecast" do
    patch forecast_url(@forecast), params: { forecast: { address: @forecast.address, data: @forecast.data } }
